...
export const dynamicRoutes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      {
        path: "/cmdb-management",
        name: "cmdb-management",
        redirect: "/cmdb-management/common-cmdb",
        meta: {
        ...
        children: [
          {
            path: "/asset-management/user-table",
            name: "user-table",
            component: () => import("@/views/asset-management/user-table/user-table.vue"),
            meta: {
              title: "user-table",
              hide: true,
              disable: false,
      ...
      },
      {
        ...
        redirect: "/asset-management/common-table",
        meta: {
      ...
      },
      {
        ...
        redirect: "/form-management/common-flow",
        meta: {
        ...
        children: [
          {
            path: "/form-management/common-flow",
            name: "common-form",
          ...
          {
            path: "/form-management/step-flow",
            name: "step-form",
