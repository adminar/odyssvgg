<template>
  <div class="odyssey-page">
    <a-card title="简介">
      <div>
        <p>odyssey 一款基于 Vue、TypeScript、Vite5、Pinia、arco-design开源的后台管理框架，使用目前最新技术栈开发。</p>
...
const projectInfo: any = [
  ...
  },
  {
    label: "GitHub",
    link: true,
    value: "https://github.com/Riyoukou/odyssey"
  },
  {
    label: "Gitee",
    link: true,
  ...
  },
  {
    label: "文档地址",
    link: true,
    value: "https://github.com/Riyoukou/odysseyr"
  },
  {
    label: "预览地址",
    link: true,
